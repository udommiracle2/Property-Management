      ...
      <main className="p-6 space-y-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="card p-6 flex items-center justify-between bg-[#6e70a1]">
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-widest text-stone-100">Occupancy</div>
                <div className="text-3xl font-bold text-stone-100 dark:text-stone-100">{s.occupancy}%</div>
              </div>
            ...
            <div className="card p-6 flex items-center justify-between bg-[#6e70a1]">
              <div className="space-y-1">
                <div className="text-xs uppercase tracking-widest text-stone-100">Active Tenants</div>
                <div className="text-3xl font-bold text-stone-100 dark:text-stone-100">{fmtNum(state.tenants.filter((t) => t.status === "Active").length)}</div>
              </div>
              <div className="h-12 w-12 rounded-2xl bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-400 grid place-items-center">
                <Users size={24} />
              </div>
